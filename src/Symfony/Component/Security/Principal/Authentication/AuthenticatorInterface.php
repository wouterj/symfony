...
namespace Symfony\Component\Security\Principal\Authentication;
...
/**
 * The interface for all custom ("guard") authenticators.
 *
...
interface AuthenticatorInterface extends AuthenticationEntryPointInterface
{
    ...
    /**
     * Return a Principal object based on the credentials.
     *
    ...
    /**
     * Create an authenticated token for the given principal.
     *
